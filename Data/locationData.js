...
let firstDropdownEl = document.getElementById("firstDropdown");
let secondDropdownEl = document.getElementById("secondDropdown");
let descBoxEl = document.getElementById("descBox");

firstDropdownEl.addEventListener('change', function() {
...
window.onload = () => {
  ...
  selectedStatesEl.onchange = () => {
    ...
    let parkIndex = selectedParkTypesEl.selectedIndex;
  ...
  //   Add Descriptions
  let parkBox = document.createElement("div");
  let parkDesc = document.createElement("p");
  parkDesc.textContent = stateIndex[index].City
  parkBox.appendChild(parkDesc);
  descBoxEl.appendChild(parkBox);
};
